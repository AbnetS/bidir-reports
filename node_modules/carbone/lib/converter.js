...
function detectLibreOffice (additionalPaths) {
  ...
  function _listProgramDirectories(basePath, pattern) {
    try {
      ...
      // var str =  dirs.filter(function _isLibreOfficeDirectory(dirname) {
  ...
  var _linuxDirnamePattern = /libreoffice/;
  var _windowsDirnamePattern = /LibreOffice/i;
  ...
  if (process.platform === 'darwin') {
    ...
    //_pathsToCheck.push ('/usr/bin/libreoffice');
  }
    ...
    //_pathsToCheck.push('C:\\Program Files\\LibreOffice\\program')
